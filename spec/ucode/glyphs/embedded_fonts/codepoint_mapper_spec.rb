...
RSpec.describe Ucode::Glyphs::EmbeddedFonts::CodepointMapper::TraceStrategy do
  ...
  describe "#supports?" do
    it "is true when the font appears in the indexer" do
      ...
      strategy = described_class.new(source: source, indexer: indexer, mutool_trace: mutool)
  ...
  describe "#map" do
    it "traces each page once and returns a Hash" do
    ...
    it "returns {} when trace XML is empty" do
