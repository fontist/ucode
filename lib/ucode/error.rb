...
module Ucode
  ...
  # {EmbeddedFontsMissingError} (file not found / not installed):
  # this fires when mutool ran but failed (corrupt PDF, bad object
  # ref, etc.). The context carries the argv that failed.
